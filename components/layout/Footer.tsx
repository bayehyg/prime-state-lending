      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-1">
            <Link href="/" className="text-lg font-extrabold tracking-tight text-indigo-600 flex items-center gap-2 mb-4" style={{ fontFamily: 'var(--font-logo)' }}>
            ...
            <div className="flex items-center gap-4 text-slate-400">
              <a href="mailto:info@primestatelending.com" className="hover:text-slate-900 transition-colors"><Icon icon="solar:letter-linear" className="text-xl" /></a>
              <a href="tel:+14255825615" className="hover:text-slate-900 transition-colors"><Icon icon="solar:phone-linear" className="text-xl" /></a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/loan-programs" className="text-sm text-slate-500 hover:text-slate-900 transition-colors">Loan Programs</Link></li>
              <li><Link href="/loan-process" className="text-sm text-slate-500 hover:text-slate-900 transition-colors">Loan Process</Link></li>
              <li><Link href="/mortgage-basics" className="text-sm text-slate-500 hover:text-slate-900 transition-colors">Mortgage Basics</Link></li>
        ...
        <div className="border-t border-slate-100 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-xs text-slate-400">
            © {new Date().getFullYear()} Prime State Lending. All rights reserved. <a href="https://www.nmlsconsumeraccess.org" target="_blank" rel="noopener noreferrer" className="hover:text-slate-900 transition-colors underline">NMLS #2394256</a>. Equal Housing Lender.
          </p>
          <div className="flex items-center gap-4">
            <Link href="/privacy-policy" className="text-xs text-slate-400 hover:text-slate-900 transition-colors">Privacy Policy</Link>
            <Link href="/terms" className="text-xs text-slate-400 hover:text-slate-900 transition-colors">Terms of Service</Link>
            <Link href="/legal" className="text-xs text-slate-400 hover:text-slate-900 transition-colors">Legal</Link>
          </div>
        </div>
      </div>
    </footer>
