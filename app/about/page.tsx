        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="prose prose-neutral max-w-none">
            <div className="bg-white border border-edge rounded-2xl p-8 mb-8">
              <h2 className="text-2xl font-semibold tracking-tight text-heading mb-4">Our Mission</h2>
            ...
            <div className="bg-nav text-white rounded-2xl p-8 text-center">
              ...
              <p className="text-white/60 mb-6">Let's find the perfect loan for your situation.</p>
