          ...
          <div className="space-y-8">
            ...
            <div className="bg-white border border-edge rounded-2xl p-8">
              ...
              <div className="text-sm text-body leading-relaxed space-y-4">
                ...
                <h3 className="text-base font-semibold text-heading pt-2">Loan-To-Value &amp; Debt Ratios</h3>
                <p>
                ...
                <h3 className="text-base font-semibold text-heading pt-2">Credit Scores</h3>
                <p>
                ...
                <h3 className="text-base font-semibold text-heading pt-2">Self-Employment</h3>
                <p>
                ...
                <h3 className="text-base font-semibold text-heading pt-2">Down Payment Source</h3>
                <p>
            ...
            <div className="bg-white border border-edge rounded-2xl p-8">
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-12 bg-surface text-body rounded-xl flex items-center justify-center shrink-0">
              ...
              <div className="text-sm text-body leading-relaxed space-y-4">
                ...
                <div className="bg-surface border border-edge/50 rounded-xl p-6 space-y-4">
                  <div>
                    <h3 className="text-base font-semibold text-heading mb-2">Fixed-Rate Mortgages</h3>
                    <p>
                  ...
                  <div>
                    <h3 className="text-base font-semibold text-heading mb-2">Adjustable-Rate Mortgages (ARM)</h3>
                    <p>
            ...
            <div className="bg-white border border-edge rounded-2xl p-8">
              ...
              <div className="text-sm text-body leading-relaxed space-y-4">
                ...
                <Link
                  href="/home-purchase"
                  className="inline-flex items-center gap-2 h-11 px-6 rounded-lg bg-accent text-white text-sm font-medium hover:bg-accent-hover transition-colors"
                >
            ...
            <div className="bg-white border border-edge rounded-2xl p-8">
              ...
              <div className="text-sm text-body leading-relaxed space-y-4">
                ...
                <h3 className="text-base font-semibold text-heading pt-2">The processor will evaluate:</h3>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                  {[
                    ...
                    <div key={item} className="flex items-center gap-3 p-3 rounded-lg border border-edge/50 bg-surface">
                      <Icon icon="solar:check-circle-linear" className="text-accent shrink-0" />
                      <span className="text-sm text-body">{item}</span>
                    </div>
                  ))}
                </div>

                <h3 className="text-base font-semibold text-heading pt-2">Tips for a smooth process:</h3>
